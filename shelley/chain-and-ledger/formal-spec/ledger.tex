...
No delegation or pool state updates should be performed is any script does not
validate. This includes reward withdrawals, delegations, retirements, registrations,
etc. The UTxO rule is still applied, as this is where the correctness of the
