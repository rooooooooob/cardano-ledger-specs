...
\begin{itemize}
  ...
  are included.
  \item $\fun{scrsize},~\fun{val},~\fun{txlst},~\fun{txvals}$ accessor functions added
\end{itemize}
...
%
  ...
  \begin{equation*}
    \begin{array}{r@{~\in~}l@{\qquad=\qquad}lr}
      ...
      \var{ptx}
      & \PendingTxInS
      & \TxIn \times (\HashScr \times \HashScr) \times \Value
...
\begin{figure*}[htb]
  ...
  \begin{equation*}
    \begin{array}{r@{~\in~}l@{\qquad=\qquad}l}
      ...
      \var{ptx}
      & \PendingTx
      & \powerset{\PendingTxIn} \times  \powerset{\TxOut} \times \Value \times
...
\begin{figure*}[htb]
  ...
  \begin{align*}
    ...
    & \powerset{\TxInTx} \times (\Ix \mapsto \TxOut) \times \seqof{\DCert}
      \times \Value \times (\Slot\times\Slot) \\
  ...
  \begin{equation*}
    \begin{array}{r@{~\in~}lr}
      ...
      \fun{txsize} & \Tx \to \N & \text{transaction size} \\
      ...
      \fun{scrsize} & \Script \uniondistinct \Data \to \N & \text{data size} \\
